...
;(function (t, n) {
  ...
  function Ot(t) {
    ...
    return new It(
      ...
      500 * (o - u),
      200 *
        (u - Yt((0.0193339 * e + 0.119192 * r + 0.9503041 * i) / kf)),
      t.opacity
    )
  }
  function Ft(t, n, e, r) {
  ...
  function _e(t) {
    function n(t, n) {
      ...
      var r,
        ...
        f = !1
      for (
        t.charCodeAt(u - 1) === Nh && --u,
          t.charCodeAt(u - 1) === kh && --u;
        (r = e()) !== Mh;
    ...
    function n(t) {
      function n(t) {
          ...
          if (
            ...
            for (n = -1, r = t.length; ++n < r; )
              if (48 > (u = t.charCodeAt(n)) || u > 57) {
                ;(x =
                  (46 === u ? i + t.slice(n + 1) : t.slice(n)) + x),
                  (t = t.slice(0, n))
                break
              }
        }
        ...
        switch (
          (p &&
            l &&
            ((t = e(M + t, M.length ? h - x.length : 1 / 0)),
            (M = '')),
          c)
        ) {
          case '<':
          ...
          case '^':
            t =
              M.slice(0, (w = M.length >> 1)) + f + t + x + M.slice(w)
            break
          default:
            t = M + f + t + x
        }
  ...
  function Be(t, n) {
    return Math.max(
      0,
      3 * Math.max(-8, Math.min(8, Math.floor(Le(n) / 3))) -
        Le(Math.abs(t))
    )
  }
  function He(t, n) {
  ...
  function Fr(t) {
    function n(n) {
      return (
        (n = t(n[0] * Cp, n[1] * Cp)), (n[0] *= Ap), (n[1] *= Ap), n
      )
    }
    return (
  ...
  function Yi(t) {
    function n(t) {
      return (
        (t = s(t[0] * Cp, t[1] * Cp)), [t[0] * v + u, a - t[1] * v]
      )
    }
    function e(t, n) {
  ...
  function Xo(t, n, e, r, i, o) {
    for (
      ...
      _.push(
        (u = { value: f, dice: c < s, children: y.slice(m, x) })
      ),
        u.dice
  ...
  function pu(t, n) {
    function e() {
      return (
        (i = Math.min(a.length, c.length) > 2 ? lu : fu),
        (o = u = null),
        r
      )
    }
        ...
        return (function (n, e, r) {
          ...
          switch ((r = De(null == r ? ',f' : r)).type) {
            ...
            case 'r':
              null != r.precision ||
                isNaN(
                  (i = He(a, Math.max(Math.abs(o), Math.abs(u))))
                ) ||
  ...
  function Tu() {
    ...
    return (
      ...
      (e.ticks = function (t) {
        ...
        if (!(i % 1) && d - p < v) {
          if (
            ((p = Math.round(p) - 1), (d = Math.round(d) + 1), a > 0)
          ) {
            for (; p < d; ++p)
              for (f = 1, s = u(p); f < i; ++f)
                if (!((h = s * f) < a)) {
    ...
    return Cu(
      ...
      function (t, n) {
        return (
          (n -
            t -
            (n.getTimezoneOffset() - t.getTimezoneOffset()) * Tv) /
          Nv
        )
      }
    )
    ...
    var i = t.dateTime,
      ...
      T = {
        a: function (t, n, e) {
          ...
          return r
            ? ((t.w = _[r[0].toLowerCase()]), e + r[0].length)
            : -1
        },
        A: function (t, n, e) {
        ...
        B: function (t, n, e) {
          ...
          return r
            ? ((t.m = m[r[0].toLowerCase()]), e + r[0].length)
            : -1
        },
        c: function (t, n, e) {
          return r(t, i, n, e)
        ...
        p: function (t, n, e) {
          ...
          return r
            ? ((t.p = p[r[0].toLowerCase()]), e + r[0].length)
            : -1
        },
        Q: ia,
        s: oa,
  ...
  function sc() {
    ...
    return (
      ...
      (t.x1 = function (n) {
        return arguments.length
          ? ((r =
              null == n ? null : 'function' == typeof n ? n : Ga(+n)),
            t)
          : r
      }),
      (t.y = function (n) {
  ...
  function Ms(t, n, e) {
    return (
      (t[0] - e[0]) * (n[1] - t[1]) - (t[0] - n[0]) * (e[1] - t[1])
    )
  }
  function Ts(t, n) {
  ...
  function Ns(t, n) {
    var e,
      ...
      o = t.sort(Ts).pop()
    for (
      D_ = [], L_ = new Array(t.length), R_ = new rs(), q_ = new rs();
      ;
    ...
    selectAll: function (t) {
      ...
      for (
        ...
        for (var u, a = n[o], c = a.length, s = 0; s < c; ++s)
          (u = a[s]) &&
            (r.push(t.call(u, u.__data__, s, a)), i.push(u))
      return new ut(r, i)
    },
    filter: function (t) {
  ...
  ;(Uh.copy = function () {
    ...
    (Uh.visit = function (t) {
      ...
      for (
        c &&
        a.push(new be(c, this._x0, this._y0, this._x1, this._y1));
        (n = a.pop());
    ...
    Yh = {
      ...
      s: function (t, n) {
        ...
        var r = e[0],
          ...
          o =
            i -
            (Oh = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) +
            1,
          u = r.length
        return o === u
          ? r
        ...
        r -= e =
          (r *
            (1.007226 +
              o *
                (0.015085 +
                  u * (0.028874 * o - 0.044475 - 0.005916 * u))) -
            n) /
          (1.007226 +
            o *
              (0.045255 +
                u * (0.259866 * o - 0.311325 - 0.005916 * 11 * u)))
      } while (zp(e) > Mp && --i > 0)
      return [
        t /
          (0.8707 +
            (o = r * r) *
              (o *
                (o * o * o * (0.003971 - 0.001529 * o) - 0.013791) -
                0.131979)),
        r,
      ]
    }),
  ...
  ;(Oc.prototype = {
    ...
    ((jc.prototype = Object.create(Hc.prototype)).point = function (
      t,
      n
    ) {
  ...
  ;(Es.prototype = Ss.prototype),
    ...
    (t.thresholdScott = function (t, n, e) {
      return Math.ceil(
        (e - n) / (3.5 * u(t) * Math.pow(t.length, -1 / 3))
      )
    }),
        ...
        if (a) {
          ...
          for (n = 0, c = new Array(l); n < h; ++n)
            ((e = t[n]).index = n),
              'object' != typeof e.source &&
                (e.source = Ce(p, e.source)),
              'object' != typeof e.target &&
                (e.target = Ce(p, e.target)),
          ...
          for (n = 0, s = new Array(h); n < h; ++n)
            (e = t[n]),
              (s[n] =
                c[e.source.index] /
                (c[e.source.index] + c[e.target.index]))
        ...
        (o = {
          ...
          find: function (n, e, r) {
            var i,
              ...
              f = t.length
            for (
              null == r ? (r = 1 / 0) : (r *= r), s = 0;
              s < f;
              ++s
            )
              (u = (i = n - (a = t[s]).x) * i + (o = e - a.y) * o) <
                r && ((c = a), (r = u))
            return c
          },
          on: function (t, n) {
    ...
    (t.geoCircle = function () {
      ...
      return (
        (t.center = function (n) {
          return arguments.length
            ? ((r = 'function' == typeof n ? n : Pr([+n[0], +n[1]])),
              t)
            : r
        }),
        (t.radius = function (n) {
    ...
    (t.geoPath = function (t, n) {
      ...
      return (
        ...
        (e.context = function (t) {
          return arguments.length
            ? ((i =
                null == t ? ((n = null), new Ci()) : new Si((n = t))),
    ...
    (t.tree = function () {
      function t(t) {
        var c = (function (t) {
          for (
            var n, e, r, i, o, u = new Ho(t, 0), a = [u];
            (n = a.pop());
        ...
        if (
          ...
          if (d > o_ - e_)
            ...
            var g,
              ...
              N =
                T > e_ &&
                (i ? +i.apply(this, arguments) : n_(f * f + l * l)),
    ...
    (t.pie = function () {
      function t(t) {
        var a,
          ...
          _ = Math.min(
            o_,
            Math.max(-o_, o.apply(this, arguments) - g)
          ),
    ...
    (t.stackOffsetDiverging = function (t, n) {
      if ((a = t.length) > 1)
        for (
          var e, r, i, o, u, a, c = 0, s = t[n[0]].length;
          c < s;
          ++c
        )
          for (o = u = 0, e = 0; e < a; ++e)
        ...
        if (g.apply(this, arguments)) {
          var t = u(this, arguments),
            ...
            i = Math.max(
              ...
              Math.min(
                b[1],
                n.k * Math.pow(2, m.apply(this, arguments))
              )
            ),
            o = pt(this)
          if (t.wheel)
          ...
          Cs(),
            ...
            t.zoom(
              'mouse',
              y(r(e(n, i), t.mouse[0], t.mouse[1]), t.extent, w)
            )
        }
      }
      function s() {
